...
PRFleet.base(1,1)=700; PRFleet.base(1,3)=150;  %Base 1 
PRFleet.base(2,1)=100; PRFleet.base(2,3)=300;  %Base 2 
PRFleet.base(3,1)=650; PRFleet.base(3,3)=400;  %Base 2 
...
%% Assign UAV to bases 
 ...
 PRFleet.UAV(i,1).y=PRFleet.base(i,3); %% 
